...
def main(args):
    ...
    mixup_cutmix = RandomChoice(
        transforms=[
            Mixup(num_classes=args.num_classes, mixup_alpha=0.4, cutmix_alpha=0.0),
            Mixup(num_classes=args.num_classes, mixup_alpha=0.0, cutmix_alpha=0.5)
        ],
    ...
    train_dir = get_next_train_dir(base_dir="./vit_models_v1.9_32")
    ...
    pretrained_path = "vit_models_v1.9_32/train4/best_model_vit_stage1.pth"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=3.3e-6, help='学习率')
