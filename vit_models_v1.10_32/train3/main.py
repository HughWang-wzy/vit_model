...
def main(args):
    ...
    mixup_cutmix = RandomChoice(
        transforms=[
            ...
            Mixup(num_classes=args.num_classes, mixup_alpha=0.0, cutmix_alpha=0.3)
        ],
    ...
    train_dir = get_next_train_dir(base_dir="./vit_models_v1.10_32")
    ...
    pretrained_path = "vit_models_v1.10_32/train2/best_model_vit_stage1.pth"
