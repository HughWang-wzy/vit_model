...
def main(args):
    ...
    model = SwinTransformer(
        ...
        drop_path_rate=0.02, # DropPath 比 Dropout 更常用
    ...
    train_dir = get_next_train_dir(base_dir="./swint_models_v0.8")
    ...
    pretrained_path = "swint_models_v0.8/train5/best_model_vit_stage1.pth"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=3e-6, help='学习率')
