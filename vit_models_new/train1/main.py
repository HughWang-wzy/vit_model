...
def main(args):
    ...
    mixup_cutmix = RandomChoice(
        transforms=[
            Mixup(num_classes=args.num_classes, mixup_alpha=0.2, cutmix_alpha=0.0),
    ...
    train_dir = get_next_train_dir(base_dir="./vit_models_new")
    ...
    # pretrained_path = "./vit_models/train35/best_model_vit_stage1.pth"
