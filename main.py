...
def main(args):
    ...
    model = CoAtNet(
        ...
        depths=[2, 2, 2 , 2],         # Blocks per stage (slightly adjusted)
    ...
    train_dir = get_next_train_dir(base_dir="./coatnet_models_v0.4")
    ...
    # pretrained_path = "coatnet_models_v0.2/train3/best_model_vit_stage1.pth"
