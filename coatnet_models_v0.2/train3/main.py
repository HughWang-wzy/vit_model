...
def main(args):
    ...
    model = CoAtNet(
        ...
        depths=[3, 3, 5, 2],         # Blocks per stage (slightly adjusted)
    ...
    train_dir = get_next_train_dir(base_dir="./coatnet_models_v0.2")
    ...
    pretrained_path = "coatnet_models_v0.2/train2/best_model_vit_stage1.pth"
