...
def main(args):
    ...
    model = SwinTransformer(
        ...
        depths=[2, 4, 6, 2],  # Swin-T 深度
        num_heads=[3, 6, 12, 24], # Swin-T 头数
        window_size=4,      # 关键：窗口大小改为 4 (因为 8x8 特征图)
        drop_path_rate=0.03, # DropPath 比 Dropout 更常用
    ...
    train_dir = get_next_train_dir(base_dir="./swint_models_v0.4")
    ...
    pretrained_path = "swint_models_v0.4/train3/best_model_vit_stage1.pth"
